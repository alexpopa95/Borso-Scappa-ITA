 ...
 * @author alexpopa95
 */
public class TerraPietra extends OggettoGioco implements EntitaC {
    ...
    public TerraPietra(double x, double y, Gioco game, Textures tex, Controller c) {
        super(x, y);
        this.tex = tex;
        this.game=game;
        this.c=c;
        
        anim = new Animazione(10, tex.terra[1], tex.terra[1]);
    }
