 ...
 * @author alexpopa95
 */
public class Acqua extends OggettoGioco implements EntitaD {
    ...
    public Acqua(double x, double y, Gioco game, Textures tex, Controller c) {
        super(x, y);
        this.tex = tex;
        this.game=game;
        this.c=c;
        
        anim = new Animazione(10, tex.acqua[0], tex.acqua[1], tex.acqua[2]);
    }
