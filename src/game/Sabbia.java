 ...
 * @author alexpopa95
 */
public class Sabbia extends OggettoGioco implements EntitaC {
    ...
    public Sabbia(double x, double y, Gioco game, Textures tex, Controller c) {
        super(x, y);
        this.tex = tex;
        this.game=game;
        this.c=c;
        
        anim = new Animazione(10, tex.sabbia[0], tex.sabbia[0]);
    }
