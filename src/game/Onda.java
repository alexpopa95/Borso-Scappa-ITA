 ...
 * @author alexpopa95
 */
public class Onda extends OggettoGioco implements EntitaD {
    ...
    public Onda(double x, double y, Gioco game, Textures tex, Controller c) {
        super(x, y);
        this.tex = tex;
        this.game=game;
        this.c=c;
        
        anim = new Animazione(10, tex.acqua_onda[0], tex.acqua_onda[1]);
    }
